...
int main(int argc, char* argv[]) {
    if (argc <= 1 || argc >= 8) {
        ...
        if (!strcmp(argv[1], "plano")) {
            if (argc != 6) {
                printf("Use: ./gerador plano <eixo> <comprimento> <largura> <ficheiro>\n");
            }
            else {
                char* ficheiro = strcat(diretoria, argv[5]);
                int eixo = atof(argv[2]);
                float comp = atof(argv[3]);
                float larg = atof(argv[4]);
                desenhaPlano(eixo, comp, larg, ficheiro);
            }
        }
        else if (!strcmp(argv[1], "cubo")) {
            if (argc != 7) {
                printf("Use: ./gerador cubo <x> <y> <z> <divisoes> <ficheiro>\n");
            }
            else {
            ...
            if (argc != 6) {
                printf("Use: ./gerador esfera <raio> <faces> <pilhas> <ficheiro>\n");
            }
            else {
            ...
            if (argc != 7) {
                printf("Use: ./gerador cone <raio> <altura> <faces> <pilhas> <ficheiro>\n");
            }
            else {
            ...
            if (argc != 7) {
                printf("Use: ./gerador torus <raioInt> <raioExt> <faces> <aneis> <ficheiro>\n");
            }
            else {
        ...
        if (strcmp(argv[1], "bezier") == 0) {
            ...
            if (argc < 5 || argc > 5) {
                printf("Use: ./gerador bezier <patch> <tesselacao> <output>");
            } else {
                string nomeinput = argv[2];
                string nomeoutput = argv[4];
                Bezier b;
                b.carregaPatch(dir+nomeinput,dir+nomeoutput,atoi(argv[3]));
            }
        }
    }
    return 0;
