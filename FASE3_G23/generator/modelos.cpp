    ...
    if (fd != NULL) {
        ...
        for (int i = 0; i < aneis; i++) {
            ...
            for (int j = 0; j < faces; j++) {
                ...
                x1 = (rInterno + rExterno * cos(alfaIntAnt)) * sin(alfaExtAnt);
                y1 =  rExterno * sin(alfaIntAnt);
                z1 = (rInterno + rExterno * cos(alfaIntAnt)) * cos(alfaExtAnt);

                x2 = (rInterno + rExterno * cos(alfaIntAtual)) * sin(alfaExtAnt);
                y2 =  rExterno * sin(alfaIntAtual);
                z2 = (rInterno + rExterno * cos(alfaIntAtual)) * cos(alfaExtAnt);

                x3 = (rInterno + rExterno * cos(alfaIntAnt)) * sin(alfaExtAtual);
                y3 =  rExterno * sin(alfaIntAnt);
                z3 = (rInterno + rExterno * cos(alfaIntAnt)) * cos(alfaExtAtual);

                x4 = (rInterno + rExterno * cos(alfaIntAtual)) * sin(alfaExtAtual);
                y4 =  rExterno * sin(alfaIntAtual);
                z4 = (rInterno + rExterno * cos(alfaIntAtual)) * cos(alfaExtAtual);
